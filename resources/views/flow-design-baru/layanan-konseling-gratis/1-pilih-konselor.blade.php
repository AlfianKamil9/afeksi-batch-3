        ...
        <div class="row row-cols-3 gap-5 justify-content-center mt-5">
            <div class="card col p-0">
                ...
                <div class="py-2">
                    <div class="intro p-0">
                        <div class="px-3">
                            <p class="font-head2 fw-bold mb-1">Nadia Sarasvati, S.Psi</p>
                    ...
                    <div class="px-3 mt-1">
                        ...
                        <div class="d-flex mt-1">
                            ...
                            <div class="content-konselor">
                                ...
                                <p class="font-ss mb-0">: @nadiasarasvati</p>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex justify-content-center">
                        <button class="btn-blue font-ss fw-semi-bold mt-2 px-5 py-2">Pilih Konselor</button>
                    </div>
                </div>
            </div>
            <div class="card col p-0">
