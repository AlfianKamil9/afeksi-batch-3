    ...
    <div class="container-fluid my-5">
        <form>
            <div class="mb-3">
                ...
                <input type="text" class="form-control fs-6 fw-normal" id="namaLengkap" placeholder="Jawaban anda">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control fs-6 fw-normal" id="email" placeholder="Jawaban anda">
            </div>
            <div class="mb-3">
                <label for="noWhatsapp" class="fs-5 fw-semibold form-label">No WhatsApp</label>
                <input type="text" class="form-control fs-6 fw-normal" id="noWhatsapp" placeholder="Jawaban anda">
            </div>
            <div class="mb-3">
                <label for="umur" class="fs-5 fw-semibold form-label">Umur</label>
                <input type="text" class="form-control fs-6 fw-normal" id="umur" placeholder="Jawaban anda">
            </div>
            <div class="mb-3">
                ...
                <input type="text" class="form-control fs-6 fw-normal" id="buktiFollow" placeholder="Jawaban anda">
            </div>
            <div class="mb-3">
                <label for="detailMasalah" class="fs-5 fw-semibold form-label">Detail Masalah</label>
                <textarea class="form-control fs-6 fw-normal" id="detailMasalah" rows="3" placeholder="Jawaban anda"></textarea>
            </div>
            <div class="d-flex justify-content-center">
