                                ...
                                <div class="card-wrapper swiper-wrapper">
                                    @foreach ($data as $service)
                                        <div class="swiper-slide" id="swiper-slide"
                                            style="background: linear-gradient(200deg, rgba(255, 255, 255, 0) 0%, #233dff 100%), url('/assets/img/konseling/popup/{{ $service->image }}');">
                        ...
                        <div>
                            {{-- <form action="{{ route('professional.konseling.create.first') }}" method="post">
                                ...
                                <div class="text-center mt-3 mb-3">
                                    ...
                                    <button type="submit" id="button-next-dev" class="p-2 ps-md-5 pe-md-5 rounded-3 bg-btn">Pilih Konselor</button>
                                </div>
                            {{-- </form> --}}
                        </div>
                    </div>
