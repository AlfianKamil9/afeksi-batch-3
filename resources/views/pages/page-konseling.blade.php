...
@php
    ...
    $services = [
        [
            ...
            'details' => ['Pemahaman Hubungan', 'Membangun Intimasi', 'Perencanaan Masa Depan'],
            'image' => '/assets/img/konseling/popup/layanan-konseling1.jpeg',
        ],
        [
            'title' => 'Equality Gender',
            'description' =>
                'Layanan Konseling Kesetaraan Gender di Afeksi adalah bagian integral dari produk kami yang bertujuan untuk membantu individu dan pasangan membangun hubungan yang sehat, seimbang, dan setara. Layanan ini menawarkan bimbingan profesional yang fokus pada isu-isu gender, dengan tujuan mempromosikan pemahaman yang lebih baik tentang peran dan tanggung jawab dalam hubungan.',
            'details' => ['Pemahaman Hubungan', 'Membangun Intimasi', 'Perencanaan Masa Depan'],
            'image' => '/assets/img/konseling/popup/layanan-konseling2.jpeg',
        ],
        [
            'title' => 'Education',
            'description' =>
            ...
            'details' => ['Pemahaman Hubungan', 'Membangun Intimasi', 'Perencanaan Masa Depan'],
            'image' => '/assets/img/konseling/popup/layanan-konseling3.jpeg',
        ],
        [
            'title' => 'Health',
            'description' =>
                'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.',
            'details' => ['Pemahaman Hubungan', 'Membangun Intimasi', 'Perencanaan Masa Depan'],
            'image' => '/assets/img/konseling/popup/layanan-konseling4.jpeg',
        ],
        [
            'title' => 'Family Issues',
            'description' =>
                'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industrys standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.',
            'details' => ['Pemahaman Hubungan', 'Membangun Intimasi', 'Perencanaan Masa Depan'],
            'image' => '/assets/img/konseling/popup/layanan-konseling5.jpeg',
        ],
    ];
@endphp
...
@section('content')
            ...
            <div class="container mt-5 mb-5">
                <div class="card mb-5 bg-card-custom border-0">
                    <div class="row align-items-end justify-content-center">
                        <div class="col-md-6">
                            <img src="/assets/img/konseling/RevisiKonseling-1.png" alt="Gambar Anda"
                                class="img-fluid img-konseling" />
                        </div>
                        <div class="col col-md-6 p-md-4 align-self-center ">
                            <div class="card-body bg-body-custom rounded rounded-3">
                                <h2 class="card-title mb-3 fw-bold">Professional Konseling</h2>
                                <p class="card-text mb-md-4 mb-5 mb-lg-5">Konsultasi yang dilakukan dengan professional
                                    di
                                    bidangnya
                                ...
                                @else
                                    <button class="btn btn-primary rounded-pill" style="width: 200px" id="btn-harus-login1"
                                        style="width: 100px;">Pilih</button>
                                @endauth
                            </div>
                        </div>
                    </div>
                ...
                <div class="card mb-5 bg-card-custom border-0">
                    <div class="row gap-0 align-items-end justify-content-center">
                        <div class="col-md-6 p-md-4 align-self-center">
                            <div class="card-body bg-body-custom rounded rounded-3">
                                <h2 class="card-title mb-3 fw-bold">Peers Konseling</h2>
                                ...
                                @auth
                                    <form method="POST" action="{{ route('peers.konseling.create.first') }}">
                                        @csrf
                                        <button name="value_id" type="submit" class="btn btn-primary rounded-pill"
                                            style="width: 200px" data-bs-toggle="modal" data-bs-target="#peers-konseling"
        ...
        <div class="container mt-5">
            <div class="row">
                ...
                <div class="col-md-6 order-md-1">
                    ...
                    <p>
                        Yuk, tingkatkan kualitas hubungan Anda dengan layanan konseling dan mentoring di Afeksi! Temukan
                        keseimbangan, kebahagiaan, dan kesetaraan dalam hubungan Anda. Mari kita bersama-sama membangun
                        hubungan yang sehat dan memuaskan. Bergabunglah dengan kami hari ini dan mulailah perjalanan menuju
        ...
        <div class="mt-5 mb-5">
            <div class="container-md py-5 px-4 rounded" style="background-color: #5a74fd; z-index: -3">
                ...
                " />
                        ...
                        <a href="https://wa.me/6282142625552" target="blank" class="btn-tanya mt-5">Tanya Admin Yuk
    ...
    @auth
        ...
        <div class="modal fade static" id="professional-konseling" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-body">
                        <h3 class="fw-bold text-center mt-3">
                            <span>Pilihan Layanan Professional Konseling</span>
                        </h3>
                                ...
                                <div class="card-wrapper swiper-wrapper">
                                    @foreach ($services as $service)
                                        <div class="swiper-slide" id="swiper-slide"
                                            style="background: linear-gradient(200deg, rgba(255, 255, 255, 0) 0%, #233dff 100%), url({{ $service['image'] }});">
                                            <div class="card-img-overlay d-flex flex-column justify-content-between p-2">
                                                <h5 class="card-title text-white fw-bold text-center">
                                                    {{ $service['title'] }}</h5>
                                                <div class="bg-konseling rounded-3 ">
                                                    <div class="p-ld-3 p-md-2">
                                                        <p class="text-konseling mb-0 fw-lighter">
                                                            {{ $service['description'] }}
                                                        </p>
                                                    </div>
                                                    <div class="bg-cardkonseling p-3 rounded-3 text-konseling">
                                                        <p class="text-center mb-2">Apa saja yang dibahas?</p>
                        ...
                        <div class="text-center mt-3 mb-3">
                            <button class="p-2 ps-md-5 pe-md-5 rounded-3 bg-btn">Pilih Konselor</button>
                        </div>
                    </div>
                </div>
            </div>
