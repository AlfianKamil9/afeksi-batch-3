...
@section('title', 'Pilih Paket Mentoring | AFEKSI')
...
<div class="container">
  ...
  <h5 class="fw-bold mt-5">Pilih Paket Layanan {{ $layanan }}</h5>
  <p class="text-secondary sub">
    Kami berharap bahwa layanan <span>{{ $layanan }}</span> kami akan membantu setiap orang dalam menciptakan
    hubungan yang harmonis.
  </p>
  <div class="row mb-5">
    @foreach ($data as $item)
    <div class="col-lg-6 p-2">
      <form action="/save-pilih-paket-mentoring" method="POST">
      @csrf
