...
@section('title', 'Formulir Peers Konseling | AFEKSI')
...
@section('content')
    ...
    <div class="data-diri p-3 p-md-5 mb-5">
        ...
        @endif
        <form action="{{ route('peers.konseling.process.form', $slug) }}"
            method="POST">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="email" class="form-control" id="email" name="email" placeholder="Jawaban Anda"
