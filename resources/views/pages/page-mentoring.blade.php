    ...
    <div class="container-md overflow-hidden">
        <div class="row align-items-center">
            <div class="col-md-12 text-center mt-5">
                ...
                <p class="text-body-tertiary fw-bold">Seseorang membutuhkan mentoring karena bimbingan dan dukungan yang
                    diberikan oleh seorang mentor dapat <br> membantu mereka mengembangkan potensi penuh, meningkatkan
                    keterampilan, dan mencapai tujuan mereka <br> dengan lebih efektif.</p>
            </div>
                        ...
                        <div class="d-flex flex-row">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <p class="text-body-tertiary fw-bold">Mampu memberikan anda inspirasi dan membuat anda
                                        tetap fokus.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-row">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <p class="text-body-tertiary fw-bold">Dapat membantu anda menciptakan jalur karir yang
                                        sesuai dengan bakat dan minat individual.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex flex-row">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <p class="text-body-tertiary fw-bold">Dapat membantu anda menemukan cara untuk tumbuh
            ...
            <div class="mt-5">
                ...
                <p class="text-body-tertiary fw-bold text-center mt-2 mb-5">Macam-macam mentoring mencakup parenting
                    mentoring, Pre Marriage mentoring, dan Relationship <br> mentoring.</p>
            </div>
            <div class="row justify-content-center">
                <div class="col-md-3 border p-3 rounded shadow-sm me-4" id="parenting" style="cursor:pointer;">
                    <img src="assets/img/mentoring/mdi_mother-nurse.png" width="15%" alt="Logo"
                ...
                <div class="col-md-3 border p-3 rounded shadow-sm" id="relationship" style="cursor:pointer;">
                    <img src="assets/img/mentoring/material-symbols_mindfulness-rounded.png" width="15%" alt="Logo"
                        class="img-fluid mb-3">
            ...
            <div class="container mt-5">
                <div class="row">
                    ...
                    <div class="col-md-6 order-md-1">
                        ...
                        <p>Yuk, tingkatkan kualitas hubungan Anda dengan layanan konseling dan mentoring di Afeksi! Temukan
                            keseimbangan, kebahagiaan, dan kesetaraan dalam hubungan Anda. Mari kita bersama-sama membangun
                            hubungan yang sehat dan memuaskan. Bergabunglah dengan kami hari ini dan mulailah perjalanan
                            menuju hubungan yang lebih baik!</p>
                ...
                <div class="container-md py-5 px-4 rounded" style="background-color: #5a74fd; z-index:-3;">
                    <div class="row justify-content-center align-items-center">
                        <div class="col-md-6 text-center">
                            <img src="../assets/img/landingpage/tanyaadmin/tanyadmin.png" alt="tanyadmin"
                                class="img-fluid" width="400" />
                        </div>
                        <div class="col-md-5 position-relative" style="z-index:0;">
                            <img src="../assets/img/landingpage/tanyaadmin/Ellipse 1215.svg" alt=""
                                style="position: absolute; top:40px; right:120px; z-index:-1;">
                            <img src="../assets/img/landingpage/tanyaadmin/Ellipse 1215.svg" alt=""
                                style="width:30px; position: absolute; top:140px; right:300px; z-index:-1;">
                            ...
                            <a href="https://wa.me/6282142625552" target="blank" class="btn-tanya mt-5">Tanya Admin Yuk
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    fill="currentColor" class="bi bi-whatsapp pb-1" viewBox="0 0 16 16">
                                    <path
