              ...
              <table class="table table-borderless">
                <tbody>
                  <tr>
                    ...
                    <td class="text-end fw-bold">{{ $pembayaran->paket_layanan_konseling->layanan_konseling->nama_layanan }}</td>
                  </tr>
                  <tr>
                    <td class="text-muted fw-bold">Topik</td>
                    <td class="text-end fw-bold">{{ $pembayaran->paket_layanan_konseling->nama_paket }}</td>
                  </tr>
                   <tr>
                    <td class="text-muted fw-bold">Tanggal</td>
                    <td class="text-end fw-bold">{{ \Carbon\Carbon::parse($pembayaran->detail_pembayarans->tgl_konsultasi)->translatedFormat('l, d F Y') }}</td>
                  </tr>
                   <tr>
                    <td class="text-muted fw-bold">Waktu</td>
                    <td class="text-end fw-bold">{{ \Carbon\Carbon::parse($pembayaran->detail_pembayarans->jam_konsultasi)->addMinutes($pembayaran->paket_layanan_konseling->durasi)->format('H:i') }} WIB</td>
                  </tr>
                  <tr>
                    <td colspan="2">
                  ...
                  <tr>
                    ...
                    <td class="text-end fw-bold fs-5">Rp. {{ number_format($pembayaran->total_payment, 0, ',', '.') }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          <div class="container">
            <div class="row mb-3">      
              <div class="col text-center">
                <button id="pay-button" class="btn button-next" style="background-color: #2139f9; color: #fff; width: 10rem">Bayar</button>
              </div>
            </div>
          </div>
