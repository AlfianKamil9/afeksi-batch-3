...
<section id="title" class="mb-5"
    style="background-image: url(../assets/img/landingpage/bg.png); background-size: cover; padding:60px 0 50px 0;">
    <div class="container px-4 pt-5">
        <div class="row flex-lg-row-reverse align-items-center g-5 pt-5">
            <div class="col-10 col-sm-8 col-lg-6">
                <img src="../assets/img/landingpage/hero.png"
                    class="d-none d-lg-block mx-lg-auto img-fluid mt-lg-3 pt-lg-5" alt="hero" height="400"
                    loading="lazy" />
            </div>
            <div class="col-lg-6 pb-5">
                ...
                <p class="lead" style="color: #ffffff; font-size: 20px">
                    Setiap hubungan memiliki potensi untuk tumbuh dan berkembang. Temukan panduan dari para Psikolog
                    profesional kami guna mencapai
                    kualitas hubungan yang lebih dalam dan bermakna.
                </p>
                <div class="d-grid gap-2 d-md-flex justify-content-md-start">
                    <a type="button" href="#konsultasi" class="btn btn-konsultasi btn-lg px-4 me-md-2"
                        style="font-size: 15px; background-color: #233dff; color: #ffffff">
                        Mulai Konsultasi
                    </a>
                    <a href="{{ route('FAQ') }}" type="button" class="btn btn-learn btn-lg px-4"
                        style="font-size: 15px; background-color: #ffd34e">
                        Learn More
                    </a>
                </div>
            </div>
...
<section>
    <div class="mb-5">
        <div class="container px-4">
            ...
            <div class="row">
                <div class="col-sm-6 mb-3"><img src="../assets/img/landingpage/Group 2406.png" alt="group"
                        class="img-fluid" width="250" /></div>
                <div class="col-sm-6 text-center"><img src="../assets/img/landingpage/OBJECTS.png" alt="object"
                        class="img-fluid" width="400" /></div>
            </div>
        </div>
    </div>
</section>
...
<div>
    ...
    <p class="text-center">
        Semua Psikolog dan Konselor terbaik Afeksi telah berlisensi dan diakui oleh HIMPSI. Mereka siap mendengarkan dan
                    ...
                    <div class="card-wrapper swiper-wrapper">
                        @foreach ($sa as $item)
                            <div class="swiper-slide">
                                <div class="card">
                                    <img @if (Str::substr($item['profile'], 0, 8) == 'Konselor') src="../assets/img/landingpage/profilpsiko (1).png"
                        @else
                         src="../assets/img/landingpage/profilpsik (1).png" @endif
                                        class="card-img-top img-fluid" alt="psikolog" style="background-size: cover" />
                                    <div class="card-body">
    ...
    <div class="mb-5" style="background-color: #d3daff">
        <div class="container py-5 px-4">
            <div class="row text-center mb-sm-3">
                <div class="col-sm">
                    <h2 class="fw-bold" style="color: #2139f9">Pilih layanan konsultasi yang membuatmu nyaman dan tenang
                    </h2>
                    <p style="color: #717171">
                        Jangan ragu untuk memilih kami sebagai mitra dalam perjalanan menuju kebahagiaan dan
                        keberhasilan Anda!. Untuk memulai konsultasi,
            ...
            <div class="row justify-content-center">
                  ...
                  ">
                        <div class="row g-0 pt-2">
                            <div class="col-md-6 my-auto text-center">
                                <img src="../assets/img/landingpage/layanankonsultasi/konsultasi1.png"
                                    class="img-fluid rounded-start" alt="konsultasi1" />
                            </div>
                            <div class="col-md-6">
                                <div class="card-body">
                                    <h6 class="card-title fw-bold mb-1">Mentoring</h6>
                                    <p class="card-text mb-3" style="font-size: 12px">
                                        Terdapat banyak layanan mentoring, yang meliputi Parenting Mentoring, Pre
                                        Marriage Mentoring, dan Relationship Mentoring.
                ...
                <div class="col-lg-6 col-sm-12">
                  ...
                  ">
                        <div class="row g-0 pt-2">
                            <div class="col-md-6 my-auto text-center">
                                <img src="../assets/img/landingpage/layanankonsultasi/konsultasi2.png"
                                    class="img-fluid rounded-start" alt="konsultasi2" />
                            </div>
                            <div class="col-md-6">
                                <div class="card-body">
                                    <h6 class="card-title fw-bold mb-1">Konseling</h6>
                                    <p class="card-text mb-3" style="font-size: 12px">
                                        Terdapat banyak layanan konseling, yang meliputi Professional Counseling dan
                                        Peers Counseling. Segera pilih layanan
    ...
    <div class="container px-4">
        ...
        <div class="row justify-content-center align-items-center text-center">
            <div class="col-lg-2 col-sm-12 mb-sm-3">
                <img src="../assets/img/landingpage/bekerjasama/landingpagelogo3.png" alt="kementrian" class=""
                    width="140" />
            </div>
            <div class="col-lg-2 col-sm-12 mb-3">
                <img src="../assets/img/landingpage/bekerjasama/landingpagelogo4.png" alt="eternal"
                    class="img-fluid" width="140" />
            </div>
            <div class="col-lg-2 col-sm-12 mb-3">
                <img src="../assets/img/landingpage/bekerjasama/landingpagelogo1.png" alt="eternal"
                    class="img-fluid" width="140" />
            </div>
            <div class="col-lg-2 col-sm-12 mb-3">
                <img src="../assets/img/landingpage/bekerjasama/landingpagelogo2.png" alt="eternal"
                    class="img-fluid" width="140" />
            </div>
        </div>
    </div>
        ...
        <div class="container py-5 px-4 rounded" style="background-color: #5a74fd">
            <div class="row justify-content-center align-items-center">
                <div class="col-md-6 text-center">
                    <img src="../assets/img/landingpage/tanyaadmin/tanyadmin.png" alt="tanyadmin" class="img-fluid"
                        width="400" />
                </div>
                <div class="col-md-6">
                  ...
                  ">
                    ...
                    <p class="mb-4" style="color: #ffffff">
                        Masih bingung dengan layanan yang cocok dengan kamu, yuk konsultasikan bersama admin melalui
                        Whatsapp di tombol ini.
                    </p>
                    <a href="https://wa.me/6282142625552" target="blank" class="btn-tanya">Tanya Admin Yuk
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                            class="bi bi-whatsapp pb-1" viewBox="0 0 16 16">
                            <path
