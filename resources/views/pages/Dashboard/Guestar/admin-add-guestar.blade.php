...
@section('title', 'Tambah Guestar | AFEKSI')
...
@section('sidebarContent')
    <div class="container p-4">
        <div>
            <h4 class="fw-bold">Pengelolaan Data Guestar</h4>
            <p>Kelola dan atur semua guestar webinar untuk setiap detailnya.</p>
        </div>
        <div class="mt-3 bg-event shadow-sm">
            <div class="p-3">
                <h1 class="fw-bold fs-5 m-0 ">Formulir Guestar</h1>
            </div>
            <hr />
            <div class="row p-3 mt-3">
                ...
                <div class="col-md-12 mt-5">
                    ...
                    <div class="d-md-flex align-items-start mb-4">
                        <div class="col-md-2">
                            <label class="form-label">Profile Singkat</label>
                        </div>
                        <textarea rows="3" class="form-control"></textarea>
                    </div>
                </div>
                <div class="text-center mt-md-5 mt-3">
                    <button class="btn-psikolog">Simpan</button>
                </div>
...
@section('script')
    <script src="/assets/js/guestar.js"></script>
@endsection
@endsection
