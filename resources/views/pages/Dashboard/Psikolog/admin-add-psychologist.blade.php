...
@section('styles')
    <link rel="stylesheet" href="../../assets/css/psikolog/admin-add-psychologist.css">
@endsection
...
@section('sidebarContent')
    <div class="container p-4">
        ...
        <div class="mt-3 bg-event shadow-sm">
            <div class="p-3">
                <h1 class="fw-bold fs-5 m-0 ">Formulir Psikolog</h1>
            </div>
            <hr />
...
@section('script')
    <script src="/assets/js/psikolog.js"></script>
@endsection
@endsection
