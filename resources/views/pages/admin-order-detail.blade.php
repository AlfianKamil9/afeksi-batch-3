                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col mt-3">
                                                ...
                                                <p class="card-text" style="font-weight: 400; font-size:16;"><span
                                                    ...
                                                    </span><span style="color: #000000;">Budi Hartono</span></p>
                                                <p class="card-text" style="font-weight: 400; font-size:16;"><span
                                                        style="color: #606060; font-weight: bold;">Email:
                                                    </span><span style="color: #000000;">budihartono@gmail.com</span></p>
                                                <p class="card-text" style="font-weight: 400; font-size:16;"><span
                                                        style="color: #606060; font-weight: bold;">Nomor
                                                        HP: </span><span style="color: #000000;">0877028937902</span></p>
                                                <p class="card-text" style="font-weight: 400; font-size:16;"><span
                                                        style="color: #606060; font-weight: bold;">Jenis
                                                        Kelamin: </span><span style="color: #000000;">Laki-laki</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col mt-3">
                                                ...
                                                <p class="card-text" style="font-weight: 400; font-size:16;"><span
                                                    ...
                                                    </span><span style="color: #000000;">Rp100.000,.</span></p>
                                                <p class="card-text" style="font-weight: 400; font-size:16;"><span
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col mt-3">
                                                <h5 class="card-title" style="font-size: 20px; font-weight: 700;">
                                                    ...
                                                    Layanan</h5>
                                                <p class="card-text"
                                                    style="font-weight: 400; font-size:16; color:#233DFF;">Konseling</p>
                                                <p class="card-text" style="font-weight: 400; font-size:16;"><span
                                                        style="color: #606060; font-weight: bold;">Nama Paket:
                                                    </span><span style="color: #000000;">Konseling Individu</span></p>
                                                <p class="card-text" style="font-weight: 400; font-size:16;"><span
                                                        style="color: #606060; font-weight: bold;">Jumlah Sesi:
                                                    </span><span style="color: #000000;">1 Sesi</span></p>
                                                <p class="card-text" style="font-weight: 400; font-size:16;"><span
                                                        style="color: #606060; font-weight: bold;">Durasi: </span><span
                                                        style="color: #000000;">60 Menit</span></p>
                                                <p class="card-text" style="font-weight: 400; font-size:16;"><span
                                                        style="color: #606060; font-weight: bold;">Tanggal Layanan:
                                                    </span><span style="color: #000000;">Jum'at, 10 Mei 2024</span></p>
                                                <p class="card-text" style="font-weight: 400; font-size:16;"><span
                                                        style="color: #606060; font-weight: bold;">Waktu Layanan:
                                                    </span><span style="color: #000000;">10:00 WIB</span></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
