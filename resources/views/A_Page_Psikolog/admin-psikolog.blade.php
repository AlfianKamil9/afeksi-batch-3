...
@section('title', 'Dashboard Psikolog | AFEKSI')
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card py-3" style="background-color: #FFF9DB; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);">
                            <div class="card-body d-flex flex-row justify-content-around align-items-center">
                                ...
                                <div style="background-color: #FFD34E; width: 40px; height: 40px; border-radius: 20%; display: flex; justify-content: center; align-items: center;">
                                    <svg width="25" height="24" viewBox="0 0 25 24" fill="#FFF9DB" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M21.5 2H3.5C2.4 2 1.5 2.9 1.5 4V16C1.5 17.1 2.4 18 3.5 18H10.5L8.87 20.45C8.43 21.11 8.9 22 9.7 22H15.3C16.1 22 16.58 21.11 16.13 20.45L14.5 18H21.5C22.6 18 23.5 17.1 23.5 16V4C23.5 2.9 22.6 2 21.5 2ZM21.5 14H3.5V5C3.5 4.45 3.95 4 4.5 4H20.5C21.05 4 21.5 4.45 21.5 5V14Z" fill="#FFF9DB"/>
                                    </svg>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card py-3" style="background-color: #E3D8FF; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);">
                            <div class="card-body d-flex flex-row justify-content-around align-items-center">
                                ...
                                <div style="background-color: #8D6CFF; width: 40px; height: 40px; border-radius: 20%; display: flex; justify-content: center; align-items: center;">
                                        <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <g clip-path="url(#clip0_4722_7686)">
                                        <path d="M5.50003 13.1798V15.9898C5.50003 16.7198 5.90003 17.3998 6.54003 17.7498L11.54 20.4798C12.14 20.8098 12.86 20.8098 13.46 20.4798L18.46 17.7498C19.1 17.3998 19.5 16.7198 19.5 15.9898V13.1798L13.46 16.4798C12.86 16.8098 12.14 16.8098 11.54 16.4798L5.50003 13.1798ZM11.54 3.51979L3.11003 8.11978C2.42003 8.49978 2.42003 9.49978 3.11003 9.87979L11.54 14.4798C12.14 14.8098 12.86 14.8098 13.46 14.4798L21.5 10.0898V15.9998C21.5 16.5498 21.95 16.9998 22.5 16.9998C23.05 16.9998 23.5 16.5498 23.5 15.9998V9.58979C23.5 9.21979 23.3 8.88978 22.98 8.70978L13.46 3.51979C12.86 3.19979 12.14 3.19979 11.54 3.51979Z" fill="#E3D8FF"/>
                                        </g>
                                        <defs>
                    ...
                    <div class="col-md-6 mb-4">
                        <div class="card py-3" style="background-color: #DDFCD1; box-shadow: 0px 4px 4px rgba(0, 0, 0, 0.25);">
                            <div class="card-body d-flex flex-row justify-content-around align-items-center">
                                ...
                                <div style="background-color: #51E252; width: 40px; height: 40px; border-radius: 20%; display: flex; justify-content: center; align-items: center;">
                                    <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M21.5 2H3.5C2.4 2 1.5 2.9 1.5 4V16C1.5 17.1 2.4 18 3.5 18H10.5L8.87 20.45C8.43 21.11 8.9 22 9.7 22H15.3C16.1 22 16.58 21.11 16.13 20.45L14.5 18H21.5C22.6 18 23.5 17.1 23.5 16V4C23.5 2.9 22.6 2 21.5 2ZM21.5 14H3.5V5C3.5 4.45 3.95 4 4.5 4H20.5C21.05 4 21.5 4.45 21.5 5V14Z" fill="#FFF9DB"/>
                                    </svg>
                                </div>
